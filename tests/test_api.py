...
class TestEnvelope(unittest.TestCase):
    ...
    def test_verify_delegate(self) -> None:
        ...
        for role in [Timestamp, Snapshot, Targets]:
            ...
            root.verify_delegate(role.type, payload, signatures)
